...
import { fmtDate, fmtTime, jstRangeOfMonth, calcStats, unauthorized, serverError } from '@/lib/utils';
...
export async function GET(req) {
  try {
    ...
    return Response.json({ year, month, records, summary: calcStats(records.map(r => ({ ...r, cnt: 1, sales: r.amount }))) });
